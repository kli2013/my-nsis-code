...
; === Define constants ===
; **************************************************************************
!define APPNAME 	"FileGeePersonal"	; complete name of program
!define APP 		"FileGee"	; short name of program without space and accent  this one is used for the final executable an in the directory structure
!define APPEXE 		"FileGee.exe"	; main exe name
!define APPDIR 		"App\FileGee"	; main exe relative path

; ---Define Local Dirs and Portable Dirs ---
	!define LOCALDIR1 "$APPDATA\FileGee"
	!define PORTABLEDIR1 "$EXEDIR\Data\FileGee"

;--- Define RegKeys ---
	!define REGKEY1 "HKEY_CURRENT_USER\Software\TKeysoft"
